...
public interface TweetsResources {
    ...
    // the version that does not read 512MB video into memory at worst case
    UploadedMedia uploadMediaChunkedMyn(String fileName, String mediaType, String mediaCategory, InputStream media, long mediaLength) throws TwitterException;
}
